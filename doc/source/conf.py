...
latex_documents = [
    (master_doc, 'dsremap.tex', 'dsremap Documentation',
...
man_pages = [
    (master_doc, 'dsremap', 'dsremap Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dsremap', 'dsremap Documentation',
     author, 'dsremap', 'One line description of project.',
     'Miscellaneous'),
]
